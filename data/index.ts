...
const links = [
  ...
  { path: ABOUT_URL, label: "About" },
  {
    ...
    children: [
      ...
      {
        path: `${BRANCHES_URL}/hosanna`,
        label: "Hosanna Anglican Church Joyce B",
      },
...
const announcements = [
  {
    ...
    excerpt:
      "Join us for our monthly community outreach program where we serve meals to those in need.",
  },
  {
    id: 2,
    ...
    date: "October 8, 2023",
    excerpt:
      "Starting this Sunday, we'll begin our new worship series 'Faith in Action'.",
  },
  {
    id: 3,
    ...
    excerpt:
      "Our annual youth retreat is coming up. Register your teens for this life-changing weekend.",
  },
];
...
const announcements2 = [
  {
    ...
    excerpt:
      "Join us for our monthly community outreach program where we serve meals to those in need.",
    content:
      "This month, we'll be partnering with the Downtown Shelter to provide meals and essential items for families in need. We need volunteers to help prepare and serve food, as well as donate items such as canned goods, toiletries, and warm clothing. Sign up at the welcome desk or contact Sarah Johnson for more information.",
  },
  {
    id: 2,
    title: "New Worship Series",
    ...
    category: "Worship",
    image:
      "https://images.unsplash.com/photo-1508695666381-69deeaa78ccb?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    excerpt:
      "Starting this Sunday, we'll begin our new worship series 'Faith in Action'.",
    content:
      "Pastor John will be leading us through a six-week series titled 'Faith in Action' where we'll explore what it means to live out our faith in practical ways. Each week will focus on a different aspect of putting faith into practice in our daily lives. Small group study materials will be available to continue the discussion throughout the week.",
  },
  {
    id: 3,
    title: "Youth Group Retreat",
  ...
  },
  {
    ...
    category: "Children",
    image:
      "https://images.unsplash.com/photo-1576016770936-dbc4f58e1815?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    excerpt:
      "Rehearsals for the children's Christmas program will begin next Sunday after the 11:00 service.",
    content:
      "It's time to start preparing for our annual Children's Christmas Program! Rehearsals will be held on Sundays from 12:30-1:30 PM beginning October 1st. All children ages 4-12 are welcome to participate. We need kids for speaking parts, singing, and behind-the-scenes help. Parent volunteers are also needed. Please contact Mary Williams, our Children's Ministry Director, to sign up.",
  },
  {
    id: 5,
    ...
    excerpt:
      "Fall small groups are forming now. Sign up in the lobby or online to join a group.",
    content:
      "Small groups are a great way to connect with others and grow in your faith. Our fall small groups will begin meeting the first week of October and will run for 10 weeks. Groups meet on various days and times, and there are options for all ages and stages of life. You can view all available groups and sign up in the church lobby after services or on our website.",
  },
  {
    id: 6,
...
const eventsData = [
  {
    ...
    description:
      "Join us for our weekly worship service with inspiring music and a message from Pastor John Smith.",
    date: "Every Sunday",
  ...
  },
  {
    ...
    description:
      "Dive deeper into God's word with our community Bible study. This week we'll be exploring the book of James.",
    date: "Every Wednesday",
    time: "7:00 PM",
    location: "Fellowship Hall",
    image:
      "https://images.unsplash.com/photo-1504052434569-70ad5836ab65?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
  },
  {
    id: 3,
    title: "Fall Festival",
    description:
      "Annual community festival with games, food, music, and activities for all ages. Invite your friends and neighbors!",
    date: "October 22, 2023",
    time: "4:00 PM - 8:00 PM",
    location: "Church Grounds",
    image:
      "https://images.unsplash.com/photo-1601600576337-c1d8a0d1373c?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    featured: true,
  },
  {
    id: 4,
    ...
    description:
      "Weekly gathering for teens to connect, worship, and grow in their faith together.",
    date: "Every Friday",
    time: "6:30 PM",
  ...
  },
  {
    ...
    description:
      "Join us as we gather to pray for our church, community, and world needs.",
    date: "Every Tuesday",
    time: "6:00 AM",
  ...
  },
  {
    ...
    description:
      "Help us serve our local community through various outreach projects and initiatives.",
    date: "November 5, 2023",
    time: "9:00 AM - 2:00 PM",
    location: "Meet at Church Parking Lot",
    image:
      "https://images.unsplash.com/photo-1593113598332-cd59a0c3a9a1?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
  },
];
...
const galleryItems = [
  {
    ...
    images: [
      {
        url: "https://images.unsplash.com/photo-1438032005730-c779502df39b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
        alt: "Sunday worship service",
      },
      {
        url: "https://images.unsplash.com/photo-1507692049790-de58290a4334?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
  ...
  },
  {
    ...
    images: [
      {
        url: "https://images.unsplash.com/photo-1526976668912-1a811878dd37?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
        alt: "Youth group meeting",
      },
      {
        url: "https://images.unsplash.com/photo-1602873689523-b2c167e85522?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
        alt: "Youth retreat",
      },
      {
        url: "https://images.unsplash.com/photo-1528834342297-fdefb9a5a92b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
        alt: "Teen worship",
      },
    ],
  },
...
const branches: Branch[] = [
  {
    ...
    story: {
      title: "Our Story",
      desc1:
        "Emmanuel Anglican Church was founded with a vision to bring the gospel to the heart of the community. Over the years, we have grown into a vibrant congregation committed to worship, discipleship, and service.",
      desc2:
