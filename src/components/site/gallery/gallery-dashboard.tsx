...
import type { GalleryCategoryView } from '@/utilities/churchContent'
import Image from 'next/image'
import React from 'react'

type Props = {
  galleryItems: GalleryCategoryView[]
}

export default function GalleryDashboard({ galleryItems }: Props) {
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-muted-foreground">
              Capturing moments of worship, fellowship, and community service at St. Paul&apos;s
              Anglican Church
            </p>
          </div>
