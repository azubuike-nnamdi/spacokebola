    ...
    <section id="welcome-section" className="section">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Service Times */}
          <div className="flex">
            <Card className="border border-border/50 shadow-sm hover:shadow-md transition-shadow overflow-hidden flex flex-col w-full">
          ...
          <div className="flex">
            <Card className="border border-border/50 shadow-sm hover:shadow-md transition-shadow overflow-hidden flex flex-col w-full">
              <CardContent className="pt-6 flex flex-col flex-1">
                ...
                <p className="text-center mb-4 flex-1">
